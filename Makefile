NAME_STD		= tester_std
NAME_FT			= tester_ft
NAME_SCHOOL		= tester_school
# src/vector_test.cpp src/map_test.cpp src/stack_test.cpp src/utility_test.cpp
SRC_STD			= src/main_std.cpp src/run_test_std.cpp
SRC_FT			= src/main_ft.cpp  src/run_test_ft.cpp
SRC_SCHOOL		= src/main.cpp
...
fast:
	$(CPP) $(CPPFLAGS) -DFAST -o $(NAME_STD) $(SRC_STD)
	$(CPP) $(CPPFLAGS) -DFAST -o $(NAME_FT) $(SRC_FT)
	@echo "\033[32mlaunching std test\033[0m" 
	@./$(NAME_STD)
	@echo "\033[32mlaunching ft test\033[0m" 
	@./$(NAME_FT)
