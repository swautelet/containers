NAME_STD		= tester_std
NAME_FT			= tester_ft
SRC_STD			= src/main_std.cpp src/vector_test.cpp src/map_test.cpp src/stack_test.cpp src/utility_test.cpp src/run_test.cpp
SRC_FT			= src/main_ft.cpp src/vector_test.cpp src/map_test.cpp src/stack_test.cpp src/utility_test.cpp src/run_test.cpp
